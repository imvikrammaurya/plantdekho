      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        <div className="container-fluid">
          <a className="navbar-brand" href="/">
            <img
              src="https://blogger.googleusercontent.com/img/a/AVvXsEjpiiSShcaafQcL7xsilIjDk14GL8aOSfWci4Utfv9zafEh9cjyOWm3-pOI-Sx_ZHCRuwaHb6pKpkMuXJnWrfFyEQmzcVfkpaNV-wsTA3Kw9SOu2Vcvr2BazyF2-2kTOO78MhI3avEm3oXEqnt9YaWaxLNa4D-xJzN_mo-RRzGgoLcJInAJLZeHOks-Id8"
              alt="logo"
              className="nav-logo"
            />
          </a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div>
              {currentUser ? (
                <a className="btn btn-outline-light" onClick={signOutHandler} href="/">
                  Sign Out
                </a>
              ) : (
